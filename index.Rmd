...
```{r}
intro_text <- "I am a tenured Associate Researcher at Argentina's National Research Council (CONICET) working at the Calculus Institute, University of Buenos Aires (UBA). I lead a health data science research group in formation. One of the main goals of the group is to transition from paid-wall to open science. 
